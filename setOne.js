...
// const stormi = (parm1, parm2) => `The first parameter is ${parm1}. The second parameter is ${parm2}.`



// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.

// console.log(stormi(1,2))
...
console.log(greeting('Lesley','Lopez', sayHi))
...
*/
const printIt = (arr) => `The new array plus tax = ${arr}`

console.log(pricesPlusTax(prices, printIt))
